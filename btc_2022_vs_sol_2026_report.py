...
def build_key_levels(sol_current_price, sol_anchor_price, projections):
    ...
    # Milestone analogica breve (prima conferma) pi\u00f9 vicina e pratica: almeno +5% o massimo del primo tratto breve.
    confirm_1 = max([sol_current_price * 1.05] + highs_14)
    # Milestone analogica estesa (seconda conferma): rottura pi\u00f9 importante del percorso 30/60g.
...
def build_operational_plan(sol_current_price, key_levels, verdict, phase, split_alignment, phase_gap_pct):
    ...
    if verdict.get("operational_weight", 0) == 0:
        ...
        rows = [
            ...
            ["Milestone analogica estesa (seconda conferma)", fmt_price(confirm_2), "Rende pi\u00f9 credibile il percorso, ma non sostituisce l'aderenza."],
    ...
    if "FASE ANTICIPATA" in phase.get("label", ""):
        ...
        rows = [
            ...
            ["Milestone analogica estesa (seconda conferma)", fmt_price(confirm_2), "Scenario pi\u00f9 credibile."],
    ...
    lines += [
        ...
        md_table(
            ...
            [
                ...
                ["Milestone analogica estesa (seconda conferma)", fmt_price(key_levels.get("confirm_2")), "Scenario pi\u00f9 credibile."],
