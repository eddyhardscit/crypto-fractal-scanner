...
Generato: **2026-08-27 07:32:32 CEST**  
UTC: **2026-08-27 05:32:23 UTC**
...
| --- | --- | --- | --- |
| TVL 7g | +10,39% | +1 | TVL in crescita: rete più forte. |
| DEX volume 7g | -17,56% | -1 | Volume DEX in calo: attività più debole. |
| Fees 7g | +7,29% | 0 | Fee stabili. |
| Stablecoin liquidity 7g | -0,26% | 0 | Stablecoin stabili. |
| Stake ratio | 69,02% | +1 | Quota staked alta: supply liquida più contenuta. |
...
| --- | --- | --- |
| Prezzo SOL | 100,99 $ | Prezzo spot usato per il report. |
| Market cap | 58,97 mld $ | Grandezza complessiva di mercato. |
| Volume 24h | 3,86 mld $ | Liquidità di trading spot aggregata. |
| TVL Solana | 5,77 mld $ | Capitale in DeFi su Solana. |
| TVL 7g | +10,39% | Crescita/calo DeFi a 7 giorni. |
| DEX volume 24h | 2,48 mld $ | Attività di scambio on-chain. |
| DEX volume 7g | 21,07 mld $ | Volume settimanale DEX. |
| DEX change 7g | -17,56% | Accelerazione o rallentamento DEX. |
| Fees 24h | 14,68 mln $ | Fee generate dalla chain/protocolli monitorati. |
| Fees 7g | 83,48 mln $ | Fee settimanali. |
| Fees change 7g | +7,29% | Uso rete in crescita/calo. |
| Stablecoin su Solana | 16,22 mld $ | Liquidità stabile disponibile su chain. |
| Stablecoin 7g | -0,26% | Entrata/uscita liquidità stabile. |
| Supply totale | 632.969.794 | Supply totale convertita da lamports a SOL. |
| Supply circolante | 584.062.978 | Supply circolante convertita da lamports a SOL. |
| SOL in stake | 436.884.837 | Stake attivo stimato da vote accounts. |
| Stake / supply totale | 69,02% | Quota supply totale in staking. |
| Stake / supply circolante | 74,80% | Quota supply circolante in staking. |
| Stake delinquent | 0,02% | Quota stake su validatori delinquent. |
| Validatori attivi | 686 | Validatori correnti letti da RPC. |
