...
Generato: **2026-07-11 05:02:41 CEST**  
UTC: **2026-07-11 03:02:33 UTC**
...
| --- | --- | --- | --- |
| TVL 7g | -3,70% | 0 | TVL stabile. |
| DEX volume 7g | -4,60% | 0 | Volume DEX stabile. |
| Fees 7g | +0,29% | 0 | Fee stabili. |
...
| --- | --- | --- |
| Prezzo SOL | 77,72 $ | Prezzo spot usato per il report. |
| Market cap | 45,26 mld $ | Grandezza complessiva di mercato. |
| Volume 24h | 1,85 mld $ | Liquidità di trading spot aggregata. |
| TVL Solana | 4,93 mld $ | Capitale in DeFi su Solana. |
| TVL 7g | -3,70% | Crescita/calo DeFi a 7 giorni. |
| DEX volume 24h | 1,71 mld $ | Attività di scambio on-chain. |
| DEX volume 7g | 14,42 mld $ | Volume settimanale DEX. |
| DEX change 7g | -4,60% | Accelerazione o rallentamento DEX. |
| Fees 24h | 7,55 mln $ | Fee generate dalla chain/protocolli monitorati. |
| Fees 7g | 53,80 mln $ | Fee settimanali. |
| Fees change 7g | +0,29% | Uso rete in crescita/calo. |
| Stablecoin su Solana | 15,42 mld $ | Liquidità stabile disponibile su chain. |
| Stablecoin 7g | -1,63% | Entrata/uscita liquidità stabile. |
| Supply totale | 630.102.580 | Supply totale convertita da lamports a SOL. |
| Supply circolante | 582.156.839 | Supply circolante convertita da lamports a SOL. |
...
| 2026-07-11 | 77,74 $ | 4,93 mld $ | -3,70% | 1,71 mld $ | -4,60% | 15,42 mld $ | 67,94% | 1 | NEUTRALE / MISTA |
