...
Generato: **2026-09-09 07:32:29 CEST**  
UTC: **2026-09-09 05:32:20 UTC**
...
| --- | --- | --- | --- |
| TVL 7g | +5,28% | +1 | TVL in crescita: rete più forte. |
| DEX volume 7g | +18,71% | +1 | Volume DEX in aumento: attività reale più forte. |
| Fees 7g | +30,04% | +1 | Fee in crescita: uso della rete in miglioramento. |
| Stablecoin liquidity 7g | +4,94% | +1 | Stablecoin su Solana in aumento: liquidità disponibile migliore. |
| Stake ratio | 69,22% | +1 | Quota staked alta: supply liquida più contenuta. |
...
| --- | --- | --- |
| Prezzo SOL | 104,43 $ | Prezzo spot usato per il report. |
| Market cap | 61,20 mld $ | Grandezza complessiva di mercato. |
| Volume 24h | 2,97 mld $ | Liquidità di trading spot aggregata. |
| TVL Solana | 5,94 mld $ | Capitale in DeFi su Solana. |
| TVL 7g | +5,28% | Crescita/calo DeFi a 7 giorni. |
| DEX volume 24h | 2,58 mld $ | Attività di scambio on-chain. |
| DEX volume 7g | 15,86 mld $ | Volume settimanale DEX. |
| DEX change 7g | +18,71% | Accelerazione o rallentamento DEX. |
| Fees 24h | 16,44 mln $ | Fee generate dalla chain/protocolli monitorati. |
| Fees 7g | 88,55 mln $ | Fee settimanali. |
| Fees change 7g | +30,04% | Uso rete in crescita/calo. |
| Stablecoin su Solana | 16,56 mld $ | Liquidità stabile disponibile su chain. |
| Stablecoin 7g | +4,94% | Entrata/uscita liquidità stabile. |
| Supply totale | 633.736.989 | Supply totale convertita da lamports a SOL. |
| Supply circolante | 586.250.763 | Supply circolante convertita da lamports a SOL. |
| SOL in stake | 438.653.505 | Stake attivo stimato da vote accounts. |
| Stake / supply totale | 69,22% | Quota supply totale in staking. |
| Stake / supply circolante | 74,82% | Quota supply circolante in staking. |
