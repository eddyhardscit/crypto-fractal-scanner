...
Generato: **2026-08-22 07:32:15 CEST**  
UTC: **2026-08-22 05:32:03 UTC**
...
| --- | --- | --- | --- |
| TVL 7g | +16,93% | +1 | TVL in crescita: rete più forte. |
| DEX volume 7g | +115,88% | +1 | Volume DEX in aumento: attività reale più forte. |
| Fees 7g | +63,97% | +1 | Fee in crescita: uso della rete in miglioramento. |
| Stablecoin liquidity 7g | +2,61% | +1 | Stablecoin su Solana in aumento: liquidità disponibile migliore. |
| Stake ratio | 68,52% | +1 | Quota staked alta: supply liquida più contenuta. |
...
| --- | --- | --- |
| Prezzo SOL | 93,70 $ | Prezzo spot usato per il report. |
| Market cap | 54,83 mld $ | Grandezza complessiva di mercato. |
| Volume 24h | 8,67 mld $ | Liquidità di trading spot aggregata. |
| TVL Solana | 5,62 mld $ | Capitale in DeFi su Solana. |
| TVL 7g | +16,93% | Crescita/calo DeFi a 7 giorni. |
| DEX volume 24h | 3,47 mld $ | Attività di scambio on-chain. |
| DEX volume 7g | 14,43 mld $ | Volume settimanale DEX. |
| DEX change 7g | +115,88% | Accelerazione o rallentamento DEX. |
| Fees 24h | 13,20 mln $ | Fee generate dalla chain/protocolli monitorati. |
| Fees 7g | 72,37 mln $ | Fee settimanali. |
| Fees change 7g | +63,97% | Uso rete in crescita/calo. |
| Stablecoin su Solana | 16,36 mld $ | Liquidità stabile disponibile su chain. |
| Stablecoin 7g | +2,61% | Entrata/uscita liquidità stabile. |
| Supply totale | 632.639.600 | Supply totale convertita da lamports a SOL. |
| Supply circolante | 583.177.271 | Supply circolante convertita da lamports a SOL. |
| SOL in stake | 433.485.334 | Stake attivo stimato da vote accounts. |
| Stake / supply totale | 68,52% | Quota supply totale in staking. |
| Stake / supply circolante | 74,33% | Quota supply circolante in staking. |
| Stake delinquent | 0,04% | Quota stake su validatori delinquent. |
| Validatori attivi | 684 | Validatori correnti letti da RPC. |
| Validatori delinquent | 10 | Validatori delinquent letti da RPC. |
| Inflazione stimata | 3,69% | Inflation rate da RPC. |
