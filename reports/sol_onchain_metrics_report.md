...
Generato: **2026-08-15 07:33:58 CEST**  
UTC: **2026-08-15 05:33:47 UTC**
...
| --- | --- | --- | --- |
| TVL 7g | +1,52% | 0 | TVL stabile. |
| DEX volume 7g | +20,64% | +1 | Volume DEX in aumento: attività reale più forte. |
| Fees 7g | -2,06% | 0 | Fee stabili. |
| Stablecoin liquidity 7g | -1,45% | 0 | Stablecoin stabili. |
| Stake ratio | 68,88% | +1 | Quota staked alta: supply liquida più contenuta. |
...
| Market cap | 43,94 mld $ | Grandezza complessiva di mercato. |
| Volume 24h | 1,06 mld $ | Liquidità di trading spot aggregata. |
| TVL Solana | 4,82 mld $ | Capitale in DeFi su Solana. |
| TVL 7g | +1,52% | Crescita/calo DeFi a 7 giorni. |
| DEX volume 24h | 1,64 mld $ | Attività di scambio on-chain. |
| DEX volume 7g | 11,21 mld $ | Volume settimanale DEX. |
| DEX change 7g | +20,64% | Accelerazione o rallentamento DEX. |
| Fees 24h | 8,00 mln $ | Fee generate dalla chain/protocolli monitorati. |
| Fees 7g | 66,30 mln $ | Fee settimanali. |
| Fees change 7g | -2,06% | Uso rete in crescita/calo. |
| Stablecoin su Solana | 15,94 mld $ | Liquidità stabile disponibile su chain. |
| Stablecoin 7g | -1,45% | Entrata/uscita liquidità stabile. |
| Supply totale | 632.262.375 | Supply totale convertita da lamports a SOL. |
| Supply circolante | 582.728.424 | Supply circolante convertita da lamports a SOL. |
| SOL in stake | 435.491.340 | Stake attivo stimato da vote accounts. |
| Stake / supply totale | 68,88% | Quota supply totale in staking. |
