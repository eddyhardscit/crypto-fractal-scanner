...
from shared_market_snapshot import apply_snapshot_to_ohlcv
...
def main() -> None:
    ...
    sol_df = apply_snapshot_to_ohlcv(download_daily(SOL_TICKER), SOL_TICKER)
    btc_df = apply_snapshot_to_ohlcv(download_daily(BTC_TICKER), BTC_TICKER)
